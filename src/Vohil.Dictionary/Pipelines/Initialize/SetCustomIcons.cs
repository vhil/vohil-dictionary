namespace Vohil.Dictionary.Pipelines.Initialize
{
	...
	public class SetCustomIcons
	{
		...
		public void Process(PipelineArgs args)
		{
			...
			{
				this.logger.Error($"[Vohil.Dictionary]: Unable to set custom icons", ex, this);
			}
		}
		...
		private void SetCustomIcon(Guid templateId, string icon)
		{
			...
			this.logger.Debug($"[Vohil.Dictionary]: The icon on template '{template.Paths.FullPath}' changed to '{icon}'.", this);
		}
	}
}
